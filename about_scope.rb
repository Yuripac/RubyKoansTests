...
class AboutScope < Neo::Koan
  ...
  def test_bare_bones_class_names_assume_the_current_scope
    assert_equal AboutScope::String, String
  end

  def test_nested_string_is_not_the_same_as_the_system_string
    assert_not_equal String, "HI".class
  end

  def test_use_the_prefix_scope_operator_to_force_the_global_scope
    assert_equal ::String, "HI".class
  end
  ...
  def test_class_names_are_just_constants
    assert_equal MyString, ::String
    assert_equal MyString, "HI".class
  end

  def test_constants_can_be_looked_up_explicitly
    assert_equal PI, AboutScope.const_get("PI")
    assert_equal MyString, AboutScope.const_get("MyString")
  end
